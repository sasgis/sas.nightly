...
%DCC% --no-config -B -CG -TX.exe -A"%ALIAS%" -NS"%NAMESPASE%" -E".bin" -N".dcu" -M -GD -$O- -$W+ -$D+ -D"DEBUG;%EDEF%" -I"%IPATH%" -U"%UPATH%" -R"%RPATH%" --peosversion:%PE_OS% --pesubsysversion:%PE_OS% SASPlanet.dpr
